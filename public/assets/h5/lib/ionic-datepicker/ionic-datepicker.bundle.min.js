!
    ...
    angular.module("ionic-datepicker.provider", []).provider("ionicDatePicker",
        function() {
            var e = {
                setLabel: "Set",
                todayLabel: "Today",
            ...
            this.configDatePicker = function(n) {
                ...
                this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService",
                    function(n, t, a, o) {
                        ...
                        function c(e) {
                            e.disabledDates && 0 !== e.disabledDates.length ? (u.disabledDates = [], angular.forEach(e.disabledDates,
                                function(e, n) {
                                    e = i(new Date(e)),
                        ...
                        function d(e) {
                            ...
                            for (var d = n; t >= d; d++) a = new Date(e.getFullYear(), e.getMonth(), d),
                        ...
                        return u.today = i(new Date).getTime(),
                            ...
                            u.setIonicDatePickerTodayDate = function() {
                                ...
                                u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch), l())
                            },
    ...
    angular.module("ionic-datepicker.service", []).service("IonicDatepickerService",
        function() {
