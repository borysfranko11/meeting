...
(function () {
    ...
    function createUploader(warter_marker) {
        ...
        uploader.on('uploadSuccess', function (file, res) {
            ...
            $li.find('img').attr('src2', '/' + res.data);
    ...
    function checkPicture() {
        ...
        str_url = JSON.stringify(pre_files);
    ...
    function myajaxSubmit() {//console.log($('#submit_form').serialize());return false;
        $.ajax({
            method: 'post',
            url: '/index.php/rfp/update_memo_info',
            timeout: 20000,
            beforeSend: function () {
                // 显示loading
                show_loading('请求中...');
