...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #choiced_hotel_list{position: fixed; top: 300px; right: -200px; display: -ms-flex;display: -webkit-flex;display:-moz-flex;display: flex;}
            #choiced_hotel_list .drawer-btn{display: -ms-flex;display: -webkit-flex;display:-moz-flex;display: flex; align-items: center;}
            ...
            #choiced_hotel_list .remove{height: 24px; text-align: right; line-height: 20px; font-size: 20px; color: #676a6c; cursor: pointer;}
    ...
    <body class="gray-bg">
                ...
                <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="dashed-wrapper-gray padding-none" >
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div id="map_height_refer" class="dashed-wrapper-gray padding-none m-t-md">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="">
                                                <a href="/Rfp/main_recommend?<?php echo $_SERVER["QUERY_STRING"];?>" aria-expanded="false">协议酒店</a>
                                            </li>
                                            <li class="active">
                                                <a href="javascript:;" aria-expanded="true"> 会唐优选</a>
                                            </li>
                                                    ...
                                                    <div class="inline-box">
                                                        <div class="box-left">
                                                                ...
                                                                <div class="desc-file-content">
                                                                    <a href="http://www.eventown.com/place{place_id}.html" target="_blank"> <h3>{place_name}</h3></a>
                                                                    <p class="star">
                                                                        {star_rate}
                                                                    </p>
        ...
        <script src="/assets/js/rfp/page.recommend.js"></script>
