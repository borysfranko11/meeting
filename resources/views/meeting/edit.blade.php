...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-sm-8">
        <div class="title-action">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#entrust" style="display:none;">
                我要授权
            </button>
        </div>
    </div>
                                        ...
                                        <div id="app3">
                                            <el-row v-for="(item, index) in items" class="mb15" :key="index">
                                                <div class="block el-col el-col-8">
                                                    <el-date-picker v-model="item.value1" type="date" placeholder="选择日期" :picker-options="pickerOptions0" style="width:97%;" id="date1" @change="oformatDate1(index,item.value1)">
                                                    </el-date-picker>
                                                </div>
                                                <div class="line el-col el-col-2" style="line-height:36px;" align="center">至
                                                </div>
                                                <div class="block el-col el-col-8">
                                                    <el-date-picker v-model="item.value2" align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions1" style="width:97%;" @change="oformatDate2(index,item.value2)">
                                                    </el-date-picker>
                                                </div>
                                            ...
                                            <el-button type="primary" @click="addTime">增加会议时间</el-button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div id="meetingPlace">
                                            ...
                                            <div class="block el-col el-col-10">
                                                <el-select v-model="proText" placeholder="请选择省份(支持关键字查找)" @change='proChange(proText)' name="111" value-key="id">
                                            ...
                                            <div class="block el-col el-col-9">
                                                <el-select v-model="cityText" placeholder="请选择城市(支持关键字查找)"  @change='cityChange(cityText)' filterable>
                                                <el-option v-for="item in options2" :key="item.id" :label="item.name" :value="item.name">
                                                </el-option>
                                                </el-select>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10" id="app2">
                                        <div class="avatar-uploader txt-upload">
                                            <el-upload class="el-upload el-upload--picture" action="/Meeting/uploadFile" :value="imageUrl" :headers="headers" :on-change="handleChange" :before-upload="beforeUpload" :file-list="fileList3" :data="form" :on-success="onSuccess" :on-remove="onRemove">
                            ...
                            <div id="cont3" class="step-content" style="width: 100%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10" id="pepople">
                                        <div class="avatar-uploader txt-upload">
                                            <el-upload :value="imgUrl" class="el-upload el-upload--picture" action="/Meeting/uploadFile" :headers="headers" :before-upload="beforeAvatarUpload" :on-change="handleChange" :file-list="fileList2" :show-file-list="false" :on-success="onSuccess" :data="form">
                                                <i class="el-icon-plus avatar-uploader-icon"></i>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" style="text-align: left;">会议名称：</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" style="text-align: left;">被授权人：</label>
                        <div class="col-sm-9">
                            <div id="meetingHost">
                                <el-select v-model="value8" filterable placeholder="请选择">
                                    <el-option v-for="item in options" :key="item.id" :label="item.value" :value="item.id">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" style="text-align: left;">授权凭证凭证：</label>
...
<script src="/assets/js/creatMeeting/editMeeting.js"></script>
<script type="text/javascript">

    $(document).ready(function() {
        console.log(dot+'fasdfasdf');
    });
    function dotModths(){
