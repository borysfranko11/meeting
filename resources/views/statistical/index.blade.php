        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2 class="hx-tag-extend">会议明细列表</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="javascript: void(0);">主页</a>
                        </li>
                        <li>
                            <strong>会议明细列表</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="ibox-content">
                    ...
                    <div style="position: relative;">
                                            ...
                                            <!-- <div class="col-sm-4">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" type="text" name="keyword" title="">
                                                                <span class="input-group-btn">
                                                                <button id="submit_filter" type="button" class="btn btn-info"><i class="fa fa-search"></i></button>
                                                            </span>
                                                </div>
                                            </div> -->
                                            <!-- <div class="col-sm-4">
                        ...
                        <div class="m-b-md dashed-wrapper">
                            <h3 class="m-b-md hx-tag-extend">会议明细列表</h3>
...
<script>
    $( document ).ready( function()
    {
        ...
        var table_header = [
            ...
            {"name": "ht_settlement_amount", "title": "实际金额", "breakpoints": "xs"},
        ];
        ...
        var table_list = ( function( origin )
        {
            ...
            {
                var tmp = {};
                tmp["meeting_code"] = "<a href='/Meeting/preview?rfp_id="+content['rfp_id']+"'>"+content["meeting_code"]+"</a>";
                tmp["meeting_name"] = "<a href='/Meeting/preview?rfp_id="+content['rfp_id']+"'>"+content["meeting_name"]+"</a>";
